<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EducationalResources.aspx.cs" Inherits="Agri_Energy_PROG7311_POE.EducationalResources" %>
    ...
    <form id="form1" runat="server">
        ...
        <header class="bg-success text-white text-center py-5">
            <div class="container">
                ...
                <p>Explore and enroll in our available educational offerings</p>
            </div>
        </header>
                        ...
                        <div class="col-md-4">
                            <div class="course-card">
                                ...
                                <div class="course-card-body">
                                    ...
                                    <asp:Button ID="EnrollBtn" runat="server" CssClass="btn btn-primary" Text="Enroll Now"
                                  CommandArgument='<%# Eval("ID") %>' CommandName='<%# Eval("Title") %>' OnClick="EnrollBtn_Click" />
                                </div>
                            </div>
                        </div>
                    </ItemTemplate>
